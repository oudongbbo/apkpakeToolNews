...
.method public static contentLength(Lcom/leidong/open/http/okhttp3/Headers;)J
    ...
    invoke-static {v0}, Lcom/leidong/open/http/okhttp3/internal/http/HttpHeaders;->stringToLong(Ljava/lang/String;)J
...
.method public static hasBody(Lcom/leidong/open/http/okhttp3/Response;)Z
    ...
    .line 203
    invoke-virtual {p0, v4}, Lcom/leidong/open/http/okhttp3/Response;->header(Ljava/lang/String;)Ljava/lang/String;
...
.method public static hasVaryAll(Lcom/leidong/open/http/okhttp3/Response;)Z
    ...
    invoke-static {v0}, Lcom/leidong/open/http/okhttp3/internal/http/HttpHeaders;->hasVaryAll(Lcom/leidong/open/http/okhttp3/Headers;)Z
...
.method public static parseChallenges(Lcom/leidong/open/http/okhttp3/Headers;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 157
    .local v0, "challenges":Ljava/util/List;, "Ljava/util/List<Lcom/leidong/open/http/okhttp3/Challenge;>;"
    ...
    :cond_0
    sget-object v4, Lcom/leidong/open/http/okhttp3/internal/http/HttpHeaders;->PARAMETER:Ljava/util/regex/Pattern;
    ...
    .line 168
    new-instance v6, Lcom/leidong/open/http/okhttp3/Challenge;

    invoke-direct {v6, v4, v5}, Lcom/leidong/open/http/okhttp3/Challenge;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static receiveHeaders(Lcom/leidong/open/http/okhttp3/CookieJar;Lcom/leidong/open/http/okhttp3/HttpUrl;Lcom/leidong/open/http/okhttp3/Headers;)V
    .locals 2
    .param p0, "cookieJar"    # Lcom/leidong/open/http/okhttp3/CookieJar;
    .param p1, "url"    # Lcom/leidong/open/http/okhttp3/HttpUrl;
    .param p2, "headers"    # Lcom/leidong/open/http/okhttp3/Headers;
    ...
    .line 183
    :cond_1
    invoke-interface {p0, p1, v0}, Lcom/leidong/open/http/okhttp3/CookieJar;->saveFromResponse(Lcom/leidong/open/http/okhttp3/HttpUrl;Ljava/util/List;)V
...
.method private static varyFields(Lcom/leidong/open/http/okhttp3/Response;)Ljava/util/Set;
    ...
    invoke-static {v0}, Lcom/leidong/open/http/okhttp3/internal/http/HttpHeaders;->varyFields(Lcom/leidong/open/http/okhttp3/Headers;)Ljava/util/Set;
...
.method public static varyHeaders(Lcom/leidong/open/http/okhttp3/Headers;Lcom/leidong/open/http/okhttp3/Headers;)Lcom/leidong/open/http/okhttp3/Headers;
    .locals 6
    .param p0, "requestHeaders"    # Lcom/leidong/open/http/okhttp3/Headers;
    .param p1, "responseHeaders"    # Lcom/leidong/open/http/okhttp3/Headers;
    ...
    .line 137
    .local v1, "result":Lcom/leidong/open/http/okhttp3/Headers$Builder;
    const/4 v2, 0x0
    ...
    .line 138
    invoke-virtual {p0, v2}, Lcom/leidong/open/http/okhttp3/Headers;->name(I)Ljava/lang/String;
    ...
    .line 140
    invoke-virtual {p0, v2}, Lcom/leidong/open/http/okhttp3/Headers;->value(I)Ljava/lang/String;
...
.method public static varyHeaders(Lcom/leidong/open/http/okhttp3/Response;)Lcom/leidong/open/http/okhttp3/Headers;
    ...
    .line 124
    .local v0, "requestHeaders":Lcom/leidong/open/http/okhttp3/Headers;
    invoke-virtual {p0}, Lcom/leidong/open/http/okhttp3/Response;->headers()Lcom/leidong/open/http/okhttp3/Headers;

    move-result-object v1

    .line 125
    .local v1, "responseHeaders":Lcom/leidong/open/http/okhttp3/Headers;
    invoke-static {v0, v1}, Lcom/leidong/open/http/okhttp3/internal/http/HttpHeaders;->varyHeaders(Lcom/leidong/open/http/okhttp3/Headers;Lcom/leidong/open/http/okhttp3/Headers;)Lcom/leidong/open/http/okhttp3/Headers;
...
.method public static varyMatches(Lcom/leidong/open/http/okhttp3/Response;Lcom/leidong/open/http/okhttp3/Headers;Lcom/leidong/open/http/okhttp3/Request;)Z
    .locals 4
    .param p0, "cachedResponse"    # Lcom/leidong/open/http/okhttp3/Response;
    .param p1, "cachedRequest"    # Lcom/leidong/open/http/okhttp3/Headers;
    .param p2, "newRequest"    # Lcom/leidong/open/http/okhttp3/Request;
    ...
    invoke-virtual {p1, v1}, Lcom/leidong/open/http/okhttp3/Headers;->values(Ljava/lang/String;)Ljava/util/List;

    move-result-object v2

    invoke-virtual {p2, v1}, Lcom/leidong/open/http/okhttp3/Request;->headers(Ljava/lang/String;)Ljava/util/List;
