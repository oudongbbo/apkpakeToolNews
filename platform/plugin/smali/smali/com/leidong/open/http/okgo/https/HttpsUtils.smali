.class public Lcom/leidong/open/http/okgo/https/HttpsUtils;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/leidong/open/http/okgo/https/HttpsUtils$SSLParams;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    .line 132
    new-instance v0, Lcom/leidong/open/http/okgo/https/HttpsUtils$1;

    invoke-direct {v0}, Lcom/leidong/open/http/okgo/https/HttpsUtils$1;-><init>()V

    sput-object v0, Lcom/leidong/open/http/okgo/https/HttpsUtils;->UnSafeTrustManager:Ljavax/net/ssl/X509TrustManager;

    .line 152
    new-instance v0, Lcom/leidong/open/http/okgo/https/HttpsUtils$2;

    invoke-direct {v0}, Lcom/leidong/open/http/okgo/https/HttpsUtils$2;-><init>()V

    sput-object v0, Lcom/leidong/open/http/okgo/https/HttpsUtils;->UnSafeHostnameVerifier:Ljavax/net/ssl/HostnameVerifier;
...
.method public static getSslSocketFactory(Ljavax/net/ssl/X509TrustManager;Ljava/io/InputStream;Ljava/lang/String;[Ljava/io/InputStream;)Lcom/leidong/open/http/okgo/https/HttpsUtils$SSLParams;
    .locals 7
    ...
    .line 42
    new-instance v0, Lcom/leidong/open/http/okgo/https/HttpsUtils$SSLParams;

    invoke-direct {v0}, Lcom/leidong/open/http/okgo/https/HttpsUtils$SSLParams;-><init>()V

    .line 44
    .local v0, "sslParams":Lcom/leidong/open/http/okgo/https/HttpsUtils$SSLParams;
    :try_start_0
    invoke-static {p1, p2}, Lcom/leidong/open/http/okgo/https/HttpsUtils;->prepareKeyManager(Ljava/io/InputStream;Ljava/lang/String;)[Ljavax/net/ssl/KeyManager;

    move-result-object v1

    .line 45
    .local v1, "keyManagers":[Ljavax/net/ssl/KeyManager;
    invoke-static {p3}, Lcom/leidong/open/http/okgo/https/HttpsUtils;->prepareTrustManager([Ljava/io/InputStream;)[Ljavax/net/ssl/TrustManager;
    ...
    .line 52
    invoke-static {v2}, Lcom/leidong/open/http/okgo/https/HttpsUtils;->chooseTrustManager([Ljavax/net/ssl/TrustManager;)Ljavax/net/ssl/X509TrustManager;
    ...
    .line 55
    :cond_1
    sget-object v3, Lcom/leidong/open/http/okgo/https/HttpsUtils;->UnSafeTrustManager:Ljavax/net/ssl/X509TrustManager;

    .line 58
    .restart local v3    # "manager":Ljavax/net/ssl/X509TrustManager;
    :goto_1
    const-string v4, "TLS"
    ...
    iput-object v5, v0, Lcom/leidong/open/http/okgo/https/HttpsUtils$SSLParams;->sSLSocketFactory:Ljavax/net/ssl/SSLSocketFactory;

    .line 64
    iput-object v3, v0, Lcom/leidong/open/http/okgo/https/HttpsUtils$SSLParams;->trustManager:Ljavax/net/ssl/X509TrustManager;
    :try_end_0
...
.method private static varargs prepareTrustManager([Ljava/io/InputStream;)[Ljavax/net/ssl/TrustManager;
    ...
    :try_start_2
    invoke-static {v9}, Lcom/leidong/open/http/okgo/utils/OkLogger;->e(Ljava/lang/Throwable;)V
    ...
    .line 105
    .restart local v3    # "certificateAlias":Ljava/lang/String;
    .restart local v6    # "certStream":Ljava/io/InputStream;
