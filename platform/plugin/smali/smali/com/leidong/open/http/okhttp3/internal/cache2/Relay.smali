...
.method private constructor <init>(Ljava/io/RandomAccessFile;Lcom/leidong/open/http/okio/Source;JLcom/leidong/open/http/okio/ByteString;J)V
    ...
    .line 111
    :goto_0
    iput-boolean p1, p0, Lcom/leidong/open/http/okhttp3/internal/cache2/Relay;->complete:Z
...
.method public static edit(Ljava/io/File;Lcom/leidong/open/http/okio/Source;Lcom/leidong/open/http/okio/ByteString;J)Lcom/leidong/open/http/okhttp3/internal/cache2/Relay;
    ...
    .line 128
    new-instance p0, Lcom/leidong/open/http/okhttp3/internal/cache2/Relay;
    ...
    invoke-direct/range {v0 .. v7}, Lcom/leidong/open/http/okhttp3/internal/cache2/Relay;-><init>(Ljava/io/RandomAccessFile;Lcom/leidong/open/http/okio/Source;JLcom/leidong/open/http/okio/ByteString;J)V
    ...
    .line 132
    sget-object v2, Lcom/leidong/open/http/okhttp3/internal/cache2/Relay;->PREFIX_DIRTY:Lcom/leidong/open/http/okio/ByteString;
    ...
    invoke-direct/range {v1 .. v6}, Lcom/leidong/open/http/okhttp3/internal/cache2/Relay;->writeHeader(Lcom/leidong/open/http/okio/ByteString;JJ)V
...
.method public static read(Ljava/io/File;)Lcom/leidong/open/http/okhttp3/internal/cache2/Relay;
    ...
    .line 146
    new-instance p0, Lcom/leidong/open/http/okhttp3/internal/cache2/FileOperator;

    invoke-virtual {v1}, Ljava/io/RandomAccessFile;->getChannel()Ljava/nio/channels/FileChannel;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/leidong/open/http/okhttp3/internal/cache2/FileOperator;-><init>(Ljava/nio/channels/FileChannel;)V
    ...
    .line 151
    sget-object v2, Lcom/leidong/open/http/okhttp3/internal/cache2/Relay;->PREFIX_CLEAN:Lcom/leidong/open/http/okio/ByteString;
    ...
    invoke-virtual {v0, v2, v3}, Lcom/leidong/open/http/okio/Buffer;->readByteString(J)Lcom/leidong/open/http/okio/ByteString;
    ...
    invoke-virtual {v2, v3}, Lcom/leidong/open/http/okio/ByteString;->equals(Ljava/lang/Object;)Z
    ...
    .line 153
    :cond_0
    invoke-virtual {v0}, Lcom/leidong/open/http/okio/Buffer;->readLong()J
...
.method private writeHeader(Lcom/leidong/open/http/okio/ByteString;JJ)V
    ...
    .line 168
    invoke-virtual {v3, p1}, Lcom/leidong/open/http/okio/Buffer;->write(Lcom/leidong/open/http/okio/ByteString;)Lcom/leidong/open/http/okio/Buffer;

    .line 169
    invoke-virtual {v3, p2, p3}, Lcom/leidong/open/http/okio/Buffer;->writeLong(J)Lcom/leidong/open/http/okio/Buffer;

    .line 170
    invoke-virtual {v3, p4, p5}, Lcom/leidong/open/http/okio/Buffer;->writeLong(J)Lcom/leidong/open/http/okio/Buffer;
    ...
    iget-object p1, p0, Lcom/leidong/open/http/okhttp3/internal/cache2/Relay;->file:Ljava/io/RandomAccessFile;

    invoke-virtual {p1}, Ljava/io/RandomAccessFile;->getChannel()Ljava/nio/channels/FileChannel;

    move-result-object p1

    invoke-direct {v0, p1}, Lcom/leidong/open/http/okhttp3/internal/cache2/FileOperator;-><init>(Ljava/nio/channels/FileChannel;)V
    ...
    .line 174
    invoke-virtual/range {v0 .. v5}, Lcom/leidong/open/http/okhttp3/internal/cache2/FileOperator;->write(JLcom/leidong/open/http/okio/Buffer;J)V
...
.method private writeMetadata(J)V
    ...
    invoke-virtual {v3, v0}, Lcom/leidong/open/http/okio/Buffer;->write(Lcom/leidong/open/http/okio/ByteString;)Lcom/leidong/open/http/okio/Buffer;

    .line 181
    new-instance v0, Lcom/leidong/open/http/okhttp3/internal/cache2/FileOperator;

    iget-object v1, p0, Lcom/leidong/open/http/okhttp3/internal/cache2/Relay;->file:Ljava/io/RandomAccessFile;
    ...
    .line 182
    iget-object p1, p0, Lcom/leidong/open/http/okhttp3/internal/cache2/Relay;->metadata:Lcom/leidong/open/http/okio/ByteString;
...
.method commit(J)V
    ...
    .line 199
    iget-object p1, p0, Lcom/leidong/open/http/okhttp3/internal/cache2/Relay;->upstream:Lcom/leidong/open/http/okio/Source;
    ...
    .line 200
    iput-object p1, p0, Lcom/leidong/open/http/okhttp3/internal/cache2/Relay;->upstream:Lcom/leidong/open/http/okio/Source;
