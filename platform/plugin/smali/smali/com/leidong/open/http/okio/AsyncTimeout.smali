...
.method static awaitTimeout()Lcom/leidong/open/http/okio/AsyncTimeout;
    ...
    sget-wide v4, Lcom/leidong/open/http/okio/AsyncTimeout;->IDLE_TIMEOUT_MILLIS:J
    ...
    sget-wide v2, Lcom/leidong/open/http/okio/AsyncTimeout;->IDLE_TIMEOUT_NANOS:J
    ...
    .line 366
    :cond_2
    sget-object v2, Lcom/leidong/open/http/okio/AsyncTimeout;->head:Lcom/leidong/open/http/okio/AsyncTimeout;

    iget-object v3, v0, Lcom/leidong/open/http/okio/AsyncTimeout;->next:Lcom/leidong/open/http/okio/AsyncTimeout;

    iput-object v3, v2, Lcom/leidong/open/http/okio/AsyncTimeout;->next:Lcom/leidong/open/http/okio/AsyncTimeout;
...
.method private static declared-synchronized cancelScheduledTimeout(Lcom/leidong/open/http/okio/AsyncTimeout;)Z
    ...
    .line 130
    iput-object v1, p0, Lcom/leidong/open/http/okio/AsyncTimeout;->next:Lcom/leidong/open/http/okio/AsyncTimeout;
    :try_end_0
    ...
    :cond_0
    :try_start_1
    iget-object v1, v1, Lcom/leidong/open/http/okio/AsyncTimeout;->next:Lcom/leidong/open/http/okio/AsyncTimeout;
    :try_end_1
...
.method private static declared-synchronized scheduleTimeout(Lcom/leidong/open/http/okio/AsyncTimeout;JZ)V
    ...
    iput-wide p1, p0, Lcom/leidong/open/http/okio/AsyncTimeout;->timeoutAt:J
    ...
    .line 105
    sget-object p3, Lcom/leidong/open/http/okio/AsyncTimeout;->head:Lcom/leidong/open/http/okio/AsyncTimeout;

    .line 106
    :goto_1
    iget-object v3, p3, Lcom/leidong/open/http/okio/AsyncTimeout;->next:Lcom/leidong/open/http/okio/AsyncTimeout;

    if-eqz v3, :cond_4

    iget-object v3, p3, Lcom/leidong/open/http/okio/AsyncTimeout;->next:Lcom/leidong/open/http/okio/AsyncTimeout;

    invoke-direct {v3, v1, v2}, Lcom/leidong/open/http/okio/AsyncTimeout;->remainingNanos(J)J
    ...
    .line 105
    :cond_3
    iget-object p3, p3, Lcom/leidong/open/http/okio/AsyncTimeout;->next:Lcom/leidong/open/http/okio/AsyncTimeout;
    ...
    :cond_4
    :goto_2
    iget-object p1, p3, Lcom/leidong/open/http/okio/AsyncTimeout;->next:Lcom/leidong/open/http/okio/AsyncTimeout;

    iput-object p1, p0, Lcom/leidong/open/http/okio/AsyncTimeout;->next:Lcom/leidong/open/http/okio/AsyncTimeout;

    .line 108
    iput-object p0, p3, Lcom/leidong/open/http/okio/AsyncTimeout;->next:Lcom/leidong/open/http/okio/AsyncTimeout;

    .line 109
    sget-object p0, Lcom/leidong/open/http/okio/AsyncTimeout;->head:Lcom/leidong/open/http/okio/AsyncTimeout;

    if-ne p3, p0, :cond_5

    .line 110
    const-class p0, Lcom/leidong/open/http/okio/AsyncTimeout;
