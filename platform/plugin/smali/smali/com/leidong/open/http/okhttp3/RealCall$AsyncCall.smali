...
.method protected execute()V
    ...
    invoke-virtual {v2}, Lcom/leidong/open/http/okhttp3/RealCall;->getResponseWithInterceptorChain()Lcom/leidong/open/http/okhttp3/Response;
    ...
    iget-object v3, v3, Lcom/leidong/open/http/okhttp3/RealCall;->retryAndFollowUpInterceptor:Lcom/leidong/open/http/okhttp3/internal/http/RetryAndFollowUpInterceptor;

    invoke-virtual {v3}, Lcom/leidong/open/http/okhttp3/internal/http/RetryAndFollowUpInterceptor;->isCanceled()Z
    ...
    .line 133
    :try_start_1
    iget-object v1, p0, Lcom/leidong/open/http/okhttp3/RealCall$AsyncCall;->responseCallback:Lcom/leidong/open/http/okhttp3/Callback;
    ...
    invoke-interface {v1, v2, v3}, Lcom/leidong/open/http/okhttp3/Callback;->onFailure(Lcom/leidong/open/http/okhttp3/Call;Ljava/io/IOException;)V
    ...
    invoke-interface {v1, v3, v2}, Lcom/leidong/open/http/okhttp3/Callback;->onResponse(Lcom/leidong/open/http/okhttp3/Call;Lcom/leidong/open/http/okhttp3/Response;)V
    :try_end_1
    ...
    iget-object v4, p0, Lcom/leidong/open/http/okhttp3/RealCall$AsyncCall;->this$0:Lcom/leidong/open/http/okhttp3/RealCall;

    invoke-virtual {v4}, Lcom/leidong/open/http/okhttp3/RealCall;->toLoggableString()Ljava/lang/String;
    ...
    invoke-virtual {v0, v2, v3, v1}, Lcom/leidong/open/http/okhttp3/internal/platform/Platform;->log(ILjava/lang/String;Ljava/lang/Throwable;)V

    goto :goto_1

    .line 143
    :cond_1
    iget-object v0, p0, Lcom/leidong/open/http/okhttp3/RealCall$AsyncCall;->responseCallback:Lcom/leidong/open/http/okhttp3/Callback;

    iget-object v2, p0, Lcom/leidong/open/http/okhttp3/RealCall$AsyncCall;->this$0:Lcom/leidong/open/http/okhttp3/RealCall;

    invoke-interface {v0, v2, v1}, Lcom/leidong/open/http/okhttp3/Callback;->onFailure(Lcom/leidong/open/http/okhttp3/Call;Ljava/io/IOException;)V
    :try_end_2
    ...
    iget-object v0, v0, Lcom/leidong/open/http/okhttp3/RealCall;->client:Lcom/leidong/open/http/okhttp3/OkHttpClient;

    invoke-virtual {v0}, Lcom/leidong/open/http/okhttp3/OkHttpClient;->dispatcher()Lcom/leidong/open/http/okhttp3/Dispatcher;

    move-result-object v0

    invoke-virtual {v0, p0}, Lcom/leidong/open/http/okhttp3/Dispatcher;->finished(Lcom/leidong/open/http/okhttp3/RealCall$AsyncCall;)V
