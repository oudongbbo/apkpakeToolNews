...
.method public static checkAndInstall(ZLandroid/content/Context;Ljava/io/File;)V
    ...
    invoke-direct {v1, p1}, Lcom/leidong/sdk/framework/view/dialog/MaterialDialog;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v2, v3}, Lcom/leidong/sdk/framework/view/dialog/MaterialDialog;->setMessage(Ljava/lang/CharSequence;)Lcom/leidong/sdk/framework/view/dialog/MaterialDialog;

    move-result-object v2

    const-string v3, "\u786e\u5b9a"

    new-instance v4, Lcom/leidong/sdk/m/controller/UpdateManager$2;

    invoke-direct {v4, p1, p2}, Lcom/leidong/sdk/m/controller/UpdateManager$2;-><init>(Landroid/content/Context;Ljava/io/File;)V
    ...
    new-instance v4, Lcom/leidong/sdk/m/controller/UpdateManager$1;

    invoke-direct {v4, p0, p1, v1}, Lcom/leidong/sdk/m/controller/UpdateManager$1;-><init>(ZLandroid/content/Context;Lcom/leidong/sdk/framework/view/dialog/MaterialDialog;)V
    ...
    invoke-static {p1, v1}, Lcom/leidong/sdk/m/controller/UpdateManager;->showTips(Landroid/content/Context;Ljava/lang/String;)V
...
.method public static checkUpdate(Landroid/content/Context;ZLjava/lang/String;Ljava/lang/String;)V
    ...
    .line 50
    :cond_0
    new-instance v3, Lcom/leidong/sdk/m/views/UpdateDialog;

    invoke-direct {v3, p0, p1, p2, p3}, Lcom/leidong/sdk/m/views/UpdateDialog;-><init>(Landroid/content/Context;ZLjava/lang/String;Ljava/lang/String;)V

    .line 51
    .local v3, "update_dialog":Lcom/leidong/sdk/m/views/UpdateDialog;
    invoke-virtual {v3}, Lcom/leidong/sdk/m/views/UpdateDialog;->show()V

    .line 53
    .end local v3    # "update_dialog":Lcom/leidong/sdk/m/views/UpdateDialog;
    :goto_0
    return-void
.end method
