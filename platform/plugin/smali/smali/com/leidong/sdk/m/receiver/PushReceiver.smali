.class public Lcom/leidong/sdk/m/receiver/PushReceiver;
...
.method static synthetic access$000(Lcom/leidong/sdk/m/receiver/PushReceiver;Ljava/lang/String;)V
    .locals 0

    .line 38
    invoke-direct {p0, p1}, Lcom/leidong/sdk/m/receiver/PushReceiver;->printLog(Ljava/lang/String;)V

    return-void
.end method

.method static synthetic access$100(Lcom/leidong/sdk/m/receiver/PushReceiver;ILjava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0

    .line 38
    invoke-direct/range {p0 .. p7}, Lcom/leidong/sdk/m/receiver/PushReceiver;->pushInPicture(ILjava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method static synthetic access$200(Lcom/leidong/sdk/m/receiver/PushReceiver;ILjava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0

    .line 38
    invoke-direct/range {p0 .. p6}, Lcom/leidong/sdk/m/receiver/PushReceiver;->pushInText(ILjava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;)V
...
.method public static canrun(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcom/leidong/sdk/m/receiver/PushReceiver;->getPushTime(Landroid/content/Context;)J

    move-result-wide v2

    sub-long v4, v0, v2

    invoke-static {p0}, Lcom/leidong/sdk/m/model/MConfigManager;->getPushDelayTime(Landroid/content/Context;)J
    ...
    .line 450
    invoke-static {p0}, Lcom/leidong/sdk/m/receiver/PushReceiver;->setPushTime(Landroid/content/Context;)V

    return v0

    .line 453
    :cond_0
    invoke-static {p0}, Lcom/leidong/sdk/m/model/MConfigManager;->getIsPushDelay(Landroid/content/Context;)Z
...
.method private push(Landroid/content/Context;)V
    ...
    .line 118
    invoke-direct {p0, v0}, Lcom/leidong/sdk/m/receiver/PushReceiver;->printLog(Ljava/lang/String;)V

    .line 120
    invoke-static {p1}, Lcom/leidong/sdk/m/receiver/PushReceiver;->canrun(Landroid/content/Context;)Z
    ...
    .line 128
    new-instance v1, Lcom/leidong/sdk/m/receiver/PushReceiver$1;

    invoke-direct {v1, p0, v0}, Lcom/leidong/sdk/m/receiver/PushReceiver$1;-><init>(Lcom/leidong/sdk/m/receiver/PushReceiver;Lcom/leidong/sdk/m/http/MReqManager;)V

    invoke-virtual {v0, p1, v1}, Lcom/leidong/sdk/m/http/MReqManager;->requestPush(ZLcom/leidong/sdk/framework/http/HttpCallBack;)V
...
.method private pushInPicture(ILjava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 357
    iget-object v0, p0, Lcom/leidong/sdk/m/receiver/PushReceiver;->mContext:Landroid/content/Context;
    ...
    iget-object v2, p0, Lcom/leidong/sdk/m/receiver/PushReceiver;->mContext:Landroid/content/Context;
    ...
    .line 362
    iget p5, p0, Lcom/leidong/sdk/m/receiver/PushReceiver;->push_icon_url_id:I
    ...
    iget-object p5, p0, Lcom/leidong/sdk/m/receiver/PushReceiver;->mContext:Landroid/content/Context;

    invoke-static {p5, p7}, Lcom/leidong/sdk/framework/utils/CommonUtil;->checkPackInstalled(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 372
    iget-object p6, p0, Lcom/leidong/sdk/m/receiver/PushReceiver;->mContext:Landroid/content/Context;
...
.method private pushInText(ILjava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lcom/leidong/sdk/m/receiver/PushReceiver;->mContext:Landroid/content/Context;
    ...
    .line 395
    iget p4, p0, Lcom/leidong/sdk/m/receiver/PushReceiver;->push_icon_url_id:I
    ...
    iget-object p4, p0, Lcom/leidong/sdk/m/receiver/PushReceiver;->mContext:Landroid/content/Context;

    invoke-static {p4, p6}, Lcom/leidong/sdk/framework/utils/CommonUtil;->checkPackInstalled(Landroid/content/Context;Ljava/lang/String;)Z
...
.method private startPush(Landroid/os/Bundle;)V
    ...
    .line 264
    iget-object p1, p0, Lcom/leidong/sdk/m/receiver/PushReceiver;->mContext:Landroid/content/Context;

    invoke-static {p1}, Lcom/leidong/sdk/framework/utils/CommonUtil;->getAppIcon(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    .line 268
    new-instance v12, Lcom/leidong/sdk/m/receiver/PushReceiver$2;
    ...
    invoke-direct/range {v1 .. v10}, Lcom/leidong/sdk/m/receiver/PushReceiver$2;-><init>(Lcom/leidong/sdk/m/receiver/PushReceiver;IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;)V

    invoke-static {v11, v12}, Lcom/leidong/sdk/framework/utils/CommonUtil;->downLoadBitmap(Ljava/lang/String;Landroid/os/Handler;)V
    ...
    .line 291
    invoke-virtual/range {v1 .. v9}, Lcom/leidong/sdk/m/receiver/PushReceiver;->showPushNotice(IILandroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
# virtual methods
.method public handlePushSuccess(Ljava/lang/String;Lcom/leidong/sdk/m/interfaces/MsdkCallback;)V
    .locals 11
    ...
    .line 213
    invoke-direct {p0, v1, v2}, Lcom/leidong/sdk/m/receiver/PushReceiver;->getJsonInt(Lorg/json/JSONObject;Ljava/lang/String;)I
    ...
    .line 214
    invoke-direct {p0, v1, v3}, Lcom/leidong/sdk/m/receiver/PushReceiver;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 215
    invoke-direct {p0, v1, v4}, Lcom/leidong/sdk/m/receiver/PushReceiver;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 216
    invoke-direct {p0, v1, v5}, Lcom/leidong/sdk/m/receiver/PushReceiver;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 217
    invoke-direct {p0, v1, v6}, Lcom/leidong/sdk/m/receiver/PushReceiver;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 218
    invoke-direct {p0, v1, v7}, Lcom/leidong/sdk/m/receiver/PushReceiver;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 219
    invoke-direct {p0, v1, v8}, Lcom/leidong/sdk/m/receiver/PushReceiver;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 220
    invoke-direct {p0, v1, v9}, Lcom/leidong/sdk/m/receiver/PushReceiver;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 234
    invoke-direct {p0, v9}, Lcom/leidong/sdk/m/receiver/PushReceiver;->startPush(Landroid/os/Bundle;)V
    :try_end_0
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 54
    iput-object p1, p0, Lcom/leidong/sdk/m/receiver/PushReceiver;->mContext:Landroid/content/Context;
    ...
    const-string v0, "leidong_floatbutton_logo"

    const-string v1, "drawable"

    .line 57
    invoke-static {v0, v1, p1}, Lcom/leidong/sdk/framework/utils/CommonUtil;->getResourcesID(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)I

    move-result v0

    iput v0, p0, Lcom/leidong/sdk/m/receiver/PushReceiver;->push_icon_url_id:I
    ...
    .line 62
    invoke-direct {p0, p2}, Lcom/leidong/sdk/m/receiver/PushReceiver;->printLog(Ljava/lang/String;)V

    .line 64
    invoke-direct {p0, p1}, Lcom/leidong/sdk/m/receiver/PushReceiver;->push(Landroid/content/Context;)V
...
.method public showPushNotice(IILandroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 314
    invoke-virtual/range {v0 .. v7}, Lcom/leidong/sdk/m/receiver/PushReceiver;->showPushNotice(ILandroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public showPushNotice(ILandroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 327
    new-instance v1, Lcom/leidong/sdk/m/receiver/PushReceiver$3;
    ...
    invoke-direct/range {v2 .. v9}, Lcom/leidong/sdk/m/receiver/PushReceiver$3;-><init>(Lcom/leidong/sdk/m/receiver/PushReceiver;ILjava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {v0, v1}, Lcom/leidong/sdk/framework/utils/CommonUtil;->downLoadBitmap(Ljava/lang/String;Landroid/os/Handler;)V
    ...
    .line 350
    invoke-direct/range {v0 .. v6}, Lcom/leidong/sdk/m/receiver/PushReceiver;->pushInText(ILjava/lang/String;Ljava/lang/String;Landroid/graphics/Bitmap;Ljava/lang/String;Ljava/lang/String;)V
