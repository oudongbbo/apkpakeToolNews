...
.method static synthetic access$000(Lcom/leidong/sdk/m/http/MRepManager;Lorg/json/JSONObject;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
    .locals 0
    .param p0, "x0"    # Lcom/leidong/sdk/m/http/MRepManager;
    .param p1, "x1"    # Lorg/json/JSONObject;
    .param p2, "x2"    # Lcom/leidong/sdk/framework/http/HttpCallBack;
...
.method private handleInitApiAndWeb(Lorg/json/JSONObject;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
    ...
    invoke-static {v1}, Lcom/leidong/sdk/m/http/MReqUrls;->initChannel(Lorg/json/JSONObject;)V
    ...
    invoke-static {v2, v3}, Lcom/leidong/sdk/framework/model/config/ConfigManager;->setInitGameData(Landroid/content/Context;Ljava/lang/String;)V

    .line 164
    const-string v2, "\u521d\u59cb\u5316\u5b8c\u6210"

    invoke-interface {p2, v2}, Lcom/leidong/sdk/framework/http/HttpCallBack;->onSuccess(Ljava/lang/String;)V
    :try_end_0
...
.method private handleInitUpdate(Lorg/json/JSONObject;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
    ...
    invoke-direct {p0, v1, v4}, Lcom/leidong/sdk/m/http/MRepManager;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 130
    iget-object v5, p0, Lcom/leidong/sdk/m/http/MRepManager;->mContext:Landroid/content/Context;

    const/4 v6, 0x1

    invoke-static {v5, v6, v3, v4}, Lcom/leidong/sdk/m/controller/UpdateManager;->checkUpdate(Landroid/content/Context;ZLjava/lang/String;Ljava/lang/String;)V
...
.method public handleActiveCheckResult(Ljava/lang/String;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
    ...
    invoke-static {v1, v2}, Lcom/leidong/sdk/m/http/MRepManager;->getJsonInt(Lorg/json/JSONObject;Ljava/lang/String;)I
    ...
    invoke-interface {p2, v1}, Lcom/leidong/sdk/framework/http/HttpCallBack;->onSuccess(Ljava/lang/String;)V
    :try_end_0
    ...
    invoke-interface {p2, v2, v3}, Lcom/leidong/sdk/framework/http/HttpCallBack;->onFail(ILjava/lang/String;)V
...
.method public handleAppActive(Ljava/lang/String;Lcom/leidong/sdk/m/interfaces/MsdkCallback;)V
    ...
    invoke-direct {p0, v0, v4}, Lcom/leidong/sdk/m/http/MRepManager;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 368
    invoke-interface {p2, v5}, Lcom/leidong/sdk/m/interfaces/MsdkCallback;->onSuccess(Landroid/os/Bundle;)V
    ...
    invoke-interface {p2, v2}, Lcom/leidong/sdk/m/interfaces/MsdkCallback;->onFail(Ljava/lang/String;)V
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {p2, v1}, Lcom/leidong/sdk/m/interfaces/MsdkCallback;->onFail(Ljava/lang/String;)V
...
.method public handleInit(Ljava/lang/String;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
    ...
    invoke-static {v4, v2}, Lcom/leidong/sdk/m/utils/MsdkUtils;->unZipString(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v5}, Lcom/leidong/sdk/m/utils/MLogUtil;->w(Ljava/lang/String;)V
    ...
    .line 70
    iget-object v8, p0, Lcom/leidong/sdk/m/http/MRepManager;->mContext:Landroid/content/Context;

    invoke-static {v8, v3}, Lcom/leidong/sdk/m/model/MConfigManager;->setIsNewLogin(Landroid/content/Context;Z)V
    ...
    invoke-static {v8, v3}, Lcom/leidong/sdk/m/model/MConfigManager;->setIsNewLoginAfterChannel(Landroid/content/Context;Z)V
    ...
    invoke-static {v8, v9}, Lcom/leidong/sdk/m/model/MConfigManager;->setIsNewLogin(Landroid/content/Context;Z)V

    .line 76
    iget-object v8, p0, Lcom/leidong/sdk/m/http/MRepManager;->mContext:Landroid/content/Context;

    invoke-static {v8, v9}, Lcom/leidong/sdk/m/model/MConfigManager;->setIsNewLoginAfterChannel(Landroid/content/Context;Z)V
    ...
    invoke-direct {p0, v4, v5}, Lcom/leidong/sdk/m/http/MRepManager;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v4, v6}, Lcom/leidong/sdk/m/http/MRepManager;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v8}, Lcom/leidong/sdk/m/utils/MLogUtil;->d(Ljava/lang/String;)V

    .line 92
    iget-object v8, p0, Lcom/leidong/sdk/m/http/MRepManager;->mContext:Landroid/content/Context;

    new-instance v9, Lcom/leidong/sdk/m/http/MRepManager$1;

    invoke-direct {v9, p0, v0, p2}, Lcom/leidong/sdk/m/http/MRepManager$1;-><init>(Lcom/leidong/sdk/m/http/MRepManager;Lorg/json/JSONObject;Lcom/leidong/sdk/framework/http/HttpCallBack;)V

    invoke-static {v8, v6, v7, v3, v9}, Lcom/leidong/sdk/m/utils/MsdkUtils;->showWebDialog(Landroid/content/Context;Ljava/lang/String;ZZLcom/leidong/sdk/framework/interfaces/ResultCallback;)V
    ...
    .line 106
    :cond_3
    invoke-direct {p0, v0, p2}, Lcom/leidong/sdk/m/http/MRepManager;->handleInitUpdate(Lorg/json/JSONObject;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
...
.method public handleLoginSuccess(Ljava/lang/String;Lcom/leidong/sdk/m/interfaces/MsdkCallback;)V
    ...
    invoke-static {v2, v1}, Lcom/leidong/sdk/m/utils/MsdkUtils;->unZipString(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    .line 255
    .local v2, "uinfo_decode":Ljava/lang/String;
    invoke-static {v2}, Lcom/leidong/sdk/m/utils/MLogUtil;->w(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v3, v5}, Lcom/leidong/sdk/m/http/MRepManager;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v5

    invoke-static {v4, v5}, Lcom/leidong/sdk/framework/model/config/ConfigManager;->setUserId(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v4, v5}, Lcom/leidong/sdk/framework/model/config/ConfigManager;->setUserName(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v4, v5}, Lcom/leidong/sdk/framework/model/config/ConfigManager;->setUserVname(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v4, v5}, Lcom/leidong/sdk/framework/model/config/ConfigManager;->setUserPassword(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v5, v4}, Lcom/leidong/sdk/framework/model/config/ConfigManager;->setUserToken(Landroid/content/Context;Ljava/lang/String;)V
    ...
    iget-object v6, p0, Lcom/leidong/sdk/m/http/MRepManager;->mContext:Landroid/content/Context;

    invoke-static {v6}, Lcom/leidong/sdk/framework/model/config/ConfigManager;->getUserName(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v6}, Lcom/leidong/sdk/framework/model/config/ConfigManager;->getUserVname(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v6}, Lcom/leidong/sdk/framework/model/config/ConfigManager;->getUserPassword(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v6, v5}, Lcom/leidong/sdk/m/utils/MsdkUtils;->addAccount(Landroid/content/Context;Lcom/leidong/sdk/framework/user/UserInfoBean;)V
    ...
    iget-object v7, p0, Lcom/leidong/sdk/m/http/MRepManager;->mContext:Landroid/content/Context;

    invoke-static {v7}, Lcom/leidong/sdk/m/model/MConfigManager;->getIsNewLoginAfterChannel(Landroid/content/Context;)Z
    ...
    invoke-static {v7, v8}, Lcom/leidong/sdk/m/model/MConfigManager;->setIsNewLogin(Landroid/content/Context;Z)V

    .line 281
    :cond_0
    const-string v7, "dialog"

    invoke-direct {p0, v0, v7}, Lcom/leidong/sdk/m/http/MRepManager;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v0, v8}, Lcom/leidong/sdk/m/http/MRepManager;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v0, v9}, Lcom/leidong/sdk/m/http/MRepManager;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 292
    invoke-interface {p2, v10}, Lcom/leidong/sdk/m/interfaces/MsdkCallback;->onSuccess(Landroid/os/Bundle;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public handlePaySuccess(Ljava/lang/String;Lcom/leidong/sdk/m/interfaces/MsdkCallback;)V
    ...
    invoke-direct {p0, v5, v6}, Lcom/leidong/sdk/m/http/MRepManager;->getJsonObj(Lorg/json/JSONObject;Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    invoke-direct {p0, v0, v5}, Lcom/leidong/sdk/m/http/MRepManager;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v0, v6}, Lcom/leidong/sdk/m/http/MRepManager;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    invoke-static {v5, v6}, Lcom/leidong/sdk/m/utils/MsdkUtils;->unZipString(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v6, v7}, Lcom/leidong/sdk/m/http/MRepManager;->getJsonStr(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 200
    invoke-interface {p2, v7}, Lcom/leidong/sdk/m/interfaces/MsdkCallback;->onSuccess(Landroid/os/Bundle;)V
    ...
    invoke-interface {p2, v5}, Lcom/leidong/sdk/m/interfaces/MsdkCallback;->onFail(Ljava/lang/String;)V
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {p2, v6}, Lcom/leidong/sdk/m/interfaces/MsdkCallback;->onFail(Ljava/lang/String;)V
...
.method public handleRoleCreateTime(Ljava/lang/String;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
    ...
    invoke-interface {p2, v3}, Lcom/leidong/sdk/framework/http/HttpCallBack;->onSuccess(Ljava/lang/String;)V
    ...
    invoke-interface {p2, v0, v3}, Lcom/leidong/sdk/framework/http/HttpCallBack;->onFail(ILjava/lang/String;)V
    ...
    invoke-interface {p2, v0, v2}, Lcom/leidong/sdk/framework/http/HttpCallBack;->onFail(ILjava/lang/String;)V
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
