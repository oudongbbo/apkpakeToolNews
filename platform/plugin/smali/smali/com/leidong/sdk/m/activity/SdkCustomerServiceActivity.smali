...
.method static synthetic access$100(Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;)Ljava/lang/String;
    .locals 1
    .param p0, "x0"    # Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;
...
.method static synthetic access$400(Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;)Z
    ...
    .line 41
    iget-boolean v0, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->isTransparent:Z
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, v0}, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->setFinishOnTouchOutside(Z)V

    .line 65
    const-string v1, "window"

    invoke-virtual {p0, v1}, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iput v3, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->screenWidth:I

    .line 69
    iget v3, v2, Landroid/util/DisplayMetrics;->heightPixels:I

    iput v3, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->screenheight:I
    ...
    iput-object v4, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->currentUrl:Ljava/lang/String;
    ...
    iget-object v6, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->currentUrl:Ljava/lang/String;
    ...
    .line 76
    iget-object v4, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->currentUrl:Ljava/lang/String;
    ...
    .line 80
    :cond_0
    const-string v4, "leidong_dialog_customer"

    const-string v5, "layout"

    iget-object v6, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, v4}, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->setContentView(I)V
    ...
    iget-object v5, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->mContext:Landroid/content/Context;

    invoke-static {v5}, Lcom/leidong/sdk/framework/utils/CommonUtil;->isScreenLandscape(Landroid/content/Context;)Z
    ...
    iget v8, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->screenWidth:I
    ...
    iget v9, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->screenWidth:I
    ...
    iget v9, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->screenheight:I
    ...
    .line 93
    const-string v5, "leidong_customer_content"

    const-string v6, "id"

    iget-object v7, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->mContext:Landroid/content/Context;
    ...
    .line 93
    invoke-virtual {p0, v5}, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->findViewById(I)Landroid/view/View;
    ...
    .line 97
    const-string v6, "leidong_customer_title"

    const-string v7, "id"

    iget-object v8, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->mContext:Landroid/content/Context;

    invoke-static {v6, v7, v8}, Lcom/leidong/sdk/framework/utils/CommonUtil;->getResourcesID(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)I

    move-result v6

    invoke-virtual {p0, v6}, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->findViewById(I)Landroid/view/View;
    ...
    const-string v7, "leidong_customer_close"

    const-string v8, "id"

    iget-object v9, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->mContext:Landroid/content/Context;

    invoke-static {v7, v8, v9}, Lcom/leidong/sdk/framework/utils/CommonUtil;->getResourcesID(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)I

    move-result v7

    invoke-virtual {p0, v7}, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->findViewById(I)Landroid/view/View;
    ...
    const-string v8, "leidong_customer_rl"

    const-string v9, "id"

    iget-object v10, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->mContext:Landroid/content/Context;

    invoke-static {v8, v9, v10}, Lcom/leidong/sdk/framework/utils/CommonUtil;->getResourcesID(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)I

    move-result v8

    invoke-virtual {p0, v8}, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->findViewById(I)Landroid/view/View;

    move-result-object v8

    check-cast v8, Landroid/widget/RelativeLayout;

    iput-object v8, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->leidong_customer_rl:Landroid/widget/RelativeLayout;

    .line 100
    new-instance v8, Lcom/leidong/sdk/framework/web/webview/WebViewBase;

    iget-object v9, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->mContext:Landroid/content/Context;

    invoke-direct {v8, v9}, Lcom/leidong/sdk/framework/web/webview/WebViewBase;-><init>(Landroid/content/Context;)V

    iput-object v8, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->webView:Lcom/leidong/sdk/framework/web/webview/WebViewBase;

    .line 101
    iget-object v8, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->webView:Lcom/leidong/sdk/framework/web/webview/WebViewBase;
    ...
    invoke-virtual {v8, v9}, Lcom/leidong/sdk/framework/web/webview/WebViewBase;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    .line 103
    iget-object v8, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->leidong_customer_rl:Landroid/widget/RelativeLayout;

    iget-object v9, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->webView:Lcom/leidong/sdk/framework/web/webview/WebViewBase;

    invoke-virtual {v8, v9}, Landroid/widget/RelativeLayout;->addView(Landroid/view/View;)V

    .line 105
    new-instance v8, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity$1;

    invoke-direct {v8, p0}, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity$1;-><init>(Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;)V
    ...
    invoke-virtual {v8, v0}, Lcom/leidong/sdk/framework/web/webview/WebViewBase;->setEnableHardwareAccelerated(Z)V
    ...
    .line 121
    new-instance v8, Lcom/leidong/sdk/framework/web/plugs/SdkWebChromeClient;

    iget-object v9, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->mContext:Landroid/content/Context;

    iget-object v10, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->webLoadCallback:Lcom/leidong/sdk/framework/web/SdkWebCallback;

    invoke-direct {v8, v9, v10}, Lcom/leidong/sdk/framework/web/plugs/SdkWebChromeClient;-><init>(Landroid/content/Context;Lcom/leidong/sdk/framework/web/SdkWebCallback;)V

    iput-object v8, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->sdkWebChromeClient:Lcom/leidong/sdk/framework/web/plugs/SdkWebChromeClient;

    .line 123
    iget-object v8, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->webView:Lcom/leidong/sdk/framework/web/webview/WebViewBase;

    new-instance v9, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity$MyWebViewDownLoadListener;

    const/4 v10, 0x0

    invoke-direct {v9, p0, v10}, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity$MyWebViewDownLoadListener;-><init>(Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity$1;)V

    invoke-virtual {v8, v9}, Lcom/leidong/sdk/framework/web/webview/WebViewBase;->setDownloadListener(Landroid/webkit/DownloadListener;)V

    .line 124
    iget-object v8, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->webView:Lcom/leidong/sdk/framework/web/webview/WebViewBase;

    new-instance v9, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity$myWebViewClient;

    iget-object v10, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->mContext:Landroid/content/Context;

    invoke-direct {v9, p0, v10}, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity$myWebViewClient;-><init>(Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;Landroid/content/Context;)V

    invoke-virtual {v8, v9}, Lcom/leidong/sdk/framework/web/webview/WebViewBase;->setWebViewClient(Landroid/webkit/WebViewClient;)V

    .line 125
    iget-object v8, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->webView:Lcom/leidong/sdk/framework/web/webview/WebViewBase;

    iget-object v9, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->sdkWebChromeClient:Lcom/leidong/sdk/framework/web/plugs/SdkWebChromeClient;

    invoke-virtual {v8, v9}, Lcom/leidong/sdk/framework/web/webview/WebViewBase;->setWebChromeClient(Landroid/webkit/WebChromeClient;)V

    .line 128
    iget-object v8, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->webView:Lcom/leidong/sdk/framework/web/webview/WebViewBase;

    invoke-virtual {v8}, Lcom/leidong/sdk/framework/web/webview/WebViewBase;->getSettings()Landroid/webkit/WebSettings;
    ...
    invoke-virtual {v9}, Lcom/leidong/sdk/framework/web/webview/WebViewBase;->getSettings()Landroid/webkit/WebSettings;
    ...
    new-instance v10, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity$JsObj;

    iget-object v11, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->mContext:Landroid/content/Context;

    invoke-direct {v10, p0, v11}, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity$JsObj;-><init>(Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;Landroid/content/Context;)V

    const-string v11, "fmWebUtils"

    invoke-virtual {v9, v10, v11}, Lcom/leidong/sdk/framework/web/webview/WebViewBase;->addJavascriptInterface(Ljava/lang/Object;Ljava/lang/String;)V

    .line 133
    iget-object v9, p0, Lcom/leidong/sdk/m/activity/SdkCustomerServiceActivity;->showWebHandler:Landroid/os/Handler;
    ...
    invoke-virtual {v0, v9}, Lcom/leidong/sdk/framework/web/webview/WebViewBase;->setVisibility(I)V
