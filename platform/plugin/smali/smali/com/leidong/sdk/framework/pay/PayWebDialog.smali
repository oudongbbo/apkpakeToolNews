...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/leidong/sdk/framework/interfaces/SdkResultCallback;Lcom/leidong/sdk/framework/pay/PayInfoBean;)V
    ...
    .param p3, "payListener"    # Lcom/leidong/sdk/framework/interfaces/SdkResultCallback;
    .param p4, "infoBean"    # Lcom/leidong/sdk/framework/pay/PayInfoBean;
...
.method static synthetic access$000(Lcom/leidong/sdk/framework/pay/PayWebDialog;)Lcom/leidong/sdk/framework/web/webview/WebViewBase;
    .locals 1
    .param p0, "x0"    # Lcom/leidong/sdk/framework/pay/PayWebDialog;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v3, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->mContext:Landroid/content/Context;
    ...
    invoke-direct {v1, v3}, Lcom/leidong/sdk/framework/web/webview/WebViewBase;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->mWebView:Lcom/leidong/sdk/framework/web/webview/WebViewBase;
    ...
    invoke-virtual {v1, v3}, Lcom/leidong/sdk/framework/web/webview/WebViewBase;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {p0, v0, v1}, Lcom/leidong/sdk/framework/pay/PayWebDialog;->setContentView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    .line 77
    new-instance v1, Lcom/leidong/sdk/framework/web/plugs/SdkWebChromeClient;

    iget-object v2, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->mContext:Landroid/content/Context;

    iget-object v3, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->loadCallback:Lcom/leidong/sdk/framework/web/SdkWebCallback;

    invoke-direct {v1, v2, v3}, Lcom/leidong/sdk/framework/web/plugs/SdkWebChromeClient;-><init>(Landroid/content/Context;Lcom/leidong/sdk/framework/web/SdkWebCallback;)V

    iput-object v1, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->mWebChromeClient:Lcom/leidong/sdk/framework/web/plugs/SdkWebChromeClient;

    .line 78
    new-instance v1, Lcom/leidong/sdk/framework/web/plugs/SdkWebveiwClient;

    iget-object v2, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->mContext:Landroid/content/Context;

    iget-object v3, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->loadCallback:Lcom/leidong/sdk/framework/web/SdkWebCallback;

    invoke-direct {v1, v2, v3}, Lcom/leidong/sdk/framework/web/plugs/SdkWebveiwClient;-><init>(Landroid/content/Context;Lcom/leidong/sdk/framework/web/SdkWebCallback;)V

    iput-object v1, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->mWebClient:Lcom/leidong/sdk/framework/web/plugs/SdkWebveiwClient;

    .line 79
    iget-object v1, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->mWebView:Lcom/leidong/sdk/framework/web/webview/WebViewBase;

    iget-object v2, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->mWebChromeClient:Lcom/leidong/sdk/framework/web/plugs/SdkWebChromeClient;
    ...
    iget-object v2, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->mWebClient:Lcom/leidong/sdk/framework/web/plugs/SdkWebveiwClient;
    ...
    new-instance v2, Lcom/leidong/sdk/framework/pay/PayWebDialog$PayJsInterface;

    iget-object v3, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->mContext:Landroid/content/Context;

    invoke-direct {v2, p0, v3}, Lcom/leidong/sdk/framework/pay/PayWebDialog$PayJsInterface;-><init>(Lcom/leidong/sdk/framework/pay/PayWebDialog;Landroid/content/Context;)V

    const-string v3, "fmWebUtils"

    invoke-virtual {v1, v2, v3}, Lcom/leidong/sdk/framework/web/webview/WebViewBase;->addJavascriptInterface(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    iget-object v3, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->mWebView:Lcom/leidong/sdk/framework/web/webview/WebViewBase;

    invoke-virtual {v3}, Lcom/leidong/sdk/framework/web/webview/WebViewBase;->getSettings()Landroid/webkit/WebSettings;
    ...
    iget-object v4, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->mContext:Landroid/content/Context;

    invoke-direct {v3, v4}, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;-><init>(Landroid/content/Context;)V

    iput-object v3, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->mProgressDialog:Lcom/leidong/sdk/framework/view/loading/LoadingDialog;

    .line 89
    iget-object v3, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->mProgressDialog:Lcom/leidong/sdk/framework/view/loading/LoadingDialog;

    invoke-virtual {v3, v2}, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->setCancelable(Z)V

    .line 90
    iget-object v2, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->mProgressDialog:Lcom/leidong/sdk/framework/view/loading/LoadingDialog;

    const/4 v3, 0x0

    invoke-virtual {v2, v3}, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->setCanceledOnTouchOutside(Z)V

    .line 93
    iget-object v2, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->mWebView:Lcom/leidong/sdk/framework/web/webview/WebViewBase;

    iget-object v4, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->currentUrl:Ljava/lang/String;

    invoke-virtual {v2, v4}, Lcom/leidong/sdk/framework/web/webview/WebViewBase;->loadUrl(Ljava/lang/String;)V

    .line 95
    iget-object v2, p0, Lcom/leidong/sdk/framework/pay/PayWebDialog;->mWebView:Lcom/leidong/sdk/framework/web/webview/WebViewBase;

    invoke-virtual {v2, v3}, Lcom/leidong/sdk/framework/web/webview/WebViewBase;->setBackgroundColor(I)V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 165
    const-string v0, "leidong_tips_exit_pay"
    ...
    .line 168
    .local v1, "mMaterialDialog":Lcom/leidong/sdk/framework/view/dialog/MaterialDialog;
    invoke-virtual {v1, v0}, Lcom/leidong/sdk/framework/view/dialog/MaterialDialog;->setMessage(Ljava/lang/CharSequence;)Lcom/leidong/sdk/framework/view/dialog/MaterialDialog;

    move-result-object v2

    const-string v3, "\u53d6\u6d88"

    new-instance v4, Lcom/leidong/sdk/framework/pay/PayWebDialog$2;

    invoke-direct {v4, p0, v1}, Lcom/leidong/sdk/framework/pay/PayWebDialog$2;-><init>(Lcom/leidong/sdk/framework/pay/PayWebDialog;Lcom/leidong/sdk/framework/view/dialog/MaterialDialog;)V

    invoke-virtual {v2, v3, v4}, Lcom/leidong/sdk/framework/view/dialog/MaterialDialog;->setPositiveButton(Ljava/lang/String;Landroid/view/View$OnClickListener;)Lcom/leidong/sdk/framework/view/dialog/MaterialDialog;

    move-result-object v2

    const-string v3, "\u786e\u5b9a"

    new-instance v4, Lcom/leidong/sdk/framework/pay/PayWebDialog$1;

    invoke-direct {v4, p0, v1}, Lcom/leidong/sdk/framework/pay/PayWebDialog$1;-><init>(Lcom/leidong/sdk/framework/pay/PayWebDialog;Lcom/leidong/sdk/framework/view/dialog/MaterialDialog;)V

    .line 172
    invoke-virtual {v2, v3, v4}, Lcom/leidong/sdk/framework/view/dialog/MaterialDialog;->setNegativeButton(Ljava/lang/String;Landroid/view/View$OnClickListener;)Lcom/leidong/sdk/framework/view/dialog/MaterialDialog;
    ...
    .end local v1    # "mMaterialDialog":Lcom/leidong/sdk/framework/view/dialog/MaterialDialog;
    :cond_0
