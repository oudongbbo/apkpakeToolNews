...
.method static synthetic access$000(Lcom/leidong/sdk/framework/view/loading/LoadingDialog;)Lcom/leidong/sdk/framework/view/loading/LoadingSmile;
    .locals 1
    .param p0, "x0"    # Lcom/leidong/sdk/framework/view/loading/LoadingDialog;
...
.method static synthetic access$100(Lcom/leidong/sdk/framework/view/loading/LoadingDialog;)I
    ...
    .line 17
    iget v0, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->showTime:I
...
.method static synthetic access$300(Lcom/leidong/sdk/framework/view/loading/LoadingDialog;)Z
    ...
    .line 17
    iget-boolean v0, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->isUserTimeEnd:Z
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->mContext:Landroid/content/Context;
    ...
    invoke-static {v4, v5}, Lcom/leidong/sdk/framework/utils/CommonUtil;->dip2px(Landroid/content/Context;F)I

    move-result v4

    iget-object v6, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->mContext:Landroid/content/Context;

    invoke-static {v6, v5}, Lcom/leidong/sdk/framework/utils/CommonUtil;->dip2px(Landroid/content/Context;F)I
    ...
    invoke-static {v1, v4}, Lcom/leidong/sdk/framework/utils/CommonUtil;->dip2px(Landroid/content/Context;F)I

    move-result v1

    .line 54
    .local v1, "padding":I
    const-string v5, "leidong_sdk_loading"

    const-string v6, "drawable"

    iget-object v7, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->mContext:Landroid/content/Context;
    ...
    .line 60
    new-instance v6, Lcom/leidong/sdk/framework/view/loading/LoadingSmile;

    iget-object v7, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->mContext:Landroid/content/Context;

    invoke-direct {v6, v7}, Lcom/leidong/sdk/framework/view/loading/LoadingSmile;-><init>(Landroid/content/Context;)V

    iput-object v6, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->mLoading:Lcom/leidong/sdk/framework/view/loading/LoadingSmile;

    .line 61
    iget-object v6, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->mLoading:Lcom/leidong/sdk/framework/view/loading/LoadingSmile;

    const/4 v7, 0x1

    invoke-virtual {v6, v7}, Lcom/leidong/sdk/framework/view/loading/LoadingSmile;->setId(I)V
    ...
    invoke-static {v7, v8}, Lcom/leidong/sdk/framework/utils/CommonUtil;->dip2px(Landroid/content/Context;F)I

    move-result v7

    iget-object v9, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->mContext:Landroid/content/Context;

    invoke-static {v9, v8}, Lcom/leidong/sdk/framework/utils/CommonUtil;->dip2px(Landroid/content/Context;F)I
    ...
    invoke-static {v7, v4}, Lcom/leidong/sdk/framework/utils/CommonUtil;->dip2px(Landroid/content/Context;F)I
    ...
    .line 66
    iget-object v7, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->mLoading:Lcom/leidong/sdk/framework/view/loading/LoadingSmile;
    ...
    iget-object v8, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->mContext:Landroid/content/Context;

    invoke-direct {v7, v8}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v7, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->mTextView:Landroid/widget/TextView;

    .line 69
    iget-object v7, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->mTextView:Landroid/widget/TextView;

    const-string v8, "leidong_loading"

    iget-object v9, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->mContext:Landroid/content/Context;

    invoke-static {v8, v9}, Lcom/leidong/sdk/framework/utils/CommonUtil;->getStringByName(Ljava/lang/String;Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string v8, "leidong_white"

    iget-object v9, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->mContext:Landroid/content/Context;

    invoke-static {v8, v9}, Lcom/leidong/sdk/framework/utils/CommonUtil;->getColorByName(Ljava/lang/String;Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    iget-object v8, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->mLoading:Lcom/leidong/sdk/framework/view/loading/LoadingSmile;

    invoke-virtual {v8}, Lcom/leidong/sdk/framework/view/loading/LoadingSmile;->getId()I
    ...
    .line 75
    iget-object v4, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->mTextView:Landroid/widget/TextView;

    invoke-virtual {v2, v4, v7}, Landroid/widget/RelativeLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V

    .line 78
    invoke-virtual {p0, v0}, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->setContentView(Landroid/view/View;)V
...
.method public setLoadingMessage(Ljava/lang/CharSequence;)V
    ...
    iget-object v1, p0, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->mMessage:Ljava/lang/CharSequence;
