.class public Lcom/leidong/sdk/framework/web/SdkWebManager;
...
.method public static addSdkParams(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v0}, Lcom/leidong/sdk/framework/utils/ReqUtil;->buildWebParams(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
...
.method public static showSdkPayDialog(Landroid/content/Context;Ljava/lang/String;Lcom/leidong/sdk/framework/pay/PayInfoBean;Lcom/leidong/sdk/framework/interfaces/SdkResultCallback;)V
    ...
    invoke-static {p0, p1, p2, v0}, Lcom/leidong/sdk/framework/utils/ReqUtil;->buildPayParams(Landroid/content/Context;Ljava/lang/String;Lcom/leidong/sdk/framework/pay/PayInfoBean;Z)Ljava/lang/String;
    ...
    invoke-direct {v1, p0, v0, p3, p2}, Lcom/leidong/sdk/framework/pay/PayWebDialog;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/leidong/sdk/framework/interfaces/SdkResultCallback;Lcom/leidong/sdk/framework/pay/PayInfoBean;)V

    .line 28
    .local v1, "payView":Lcom/leidong/sdk/framework/pay/PayWebDialog;
...
.method public static showSdkWebActivity(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0, v0}, Lcom/leidong/sdk/framework/web/SdkWebManager;->showWebActivity(Landroid/content/Context;Ljava/lang/String;)V

    .line 112
    return-void
.end method

.method public static showSdkWebDialog(Landroid/content/Context;Ljava/lang/String;ZZLcom/leidong/sdk/framework/interfaces/ResultCallback;)V
    .locals 1
    .param p0, "context"    # Landroid/content/Context;
    ...
    invoke-interface {p4, v0}, Lcom/leidong/sdk/framework/interfaces/ResultCallback;->onFail(Ljava/lang/String;)V
    ...
    invoke-static {p0, v0, p2, p3, p4}, Lcom/leidong/sdk/framework/web/SdkWebManager;->showWebDialog(Landroid/content/Context;Ljava/lang/String;ZZLcom/leidong/sdk/framework/interfaces/ResultCallback;)V
...
.method public static showWebActivity(Landroid/content/Context;Ljava/lang/String;)V
    ...
    const-class v1, Lcom/leidong/sdk/framework/web/SdkWebActivity;
...
.method public static showWebDialog(Landroid/content/Context;Ljava/lang/String;ZZLcom/leidong/sdk/framework/interfaces/ResultCallback;)V
    ...
    .line 52
    .local v0, "webDialog":Lcom/leidong/sdk/framework/web/SdkWebDialog;
    ...
    .line 57
    new-instance v1, Lcom/leidong/sdk/framework/web/SdkWebManager$1;

    invoke-direct {v1, p4}, Lcom/leidong/sdk/framework/web/SdkWebManager$1;-><init>(Lcom/leidong/sdk/framework/interfaces/ResultCallback;)V
    ...
    invoke-virtual {v0, v1}, Lcom/leidong/sdk/framework/web/SdkWebDialog;->setJsInterface(Ljava/lang/Object;)V
