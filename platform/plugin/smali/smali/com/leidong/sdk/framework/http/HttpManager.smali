...
.method static synthetic access$000(Lcom/leidong/sdk/framework/http/HttpManager;)Lcom/leidong/sdk/framework/view/loading/LoadingDialog;
    .locals 1
    .param p0, "x0"    # Lcom/leidong/sdk/framework/http/HttpManager;
...
.method public get(Lcom/leidong/sdk/framework/http/HttpBean;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
    .locals 1
    .param p1, "bean"    # Lcom/leidong/sdk/framework/http/HttpBean;
...
.method public httpRequest(Ljava/lang/String;Lcom/leidong/sdk/framework/http/HttpBean;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
    ...
    .param p2, "bean"    # Lcom/leidong/sdk/framework/http/HttpBean;
    .param p3, "callback"    # Lcom/leidong/sdk/framework/http/HttpCallBack;
    ...
    invoke-interface {p3, v0, v1}, Lcom/leidong/sdk/framework/http/HttpCallBack;->onFail(ILjava/lang/String;)V
    ...
    invoke-interface {p3, v0, v5}, Lcom/leidong/sdk/framework/http/HttpCallBack;->onFail(ILjava/lang/String;)V

    .line 56
    const-string v0, "\u8bf7\u6c42\u5730\u5740\u4e0d\u80fd\u4e3a\u7a7a"

    invoke-direct {p0, v0}, Lcom/leidong/sdk/framework/http/HttpManager;->sendHttpLogWarn(Ljava/lang/String;)V
    ...
    .line 61
    iget-object v5, p0, Lcom/leidong/sdk/framework/http/HttpManager;->loadingDialog:Lcom/leidong/sdk/framework/view/loading/LoadingDialog;

    if-nez v5, :cond_2

    .line 62
    new-instance v5, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;

    iget-object v6, p0, Lcom/leidong/sdk/framework/http/HttpManager;->context:Landroid/content/Context;

    invoke-direct {v5, v6}, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;-><init>(Landroid/content/Context;)V

    iput-object v5, p0, Lcom/leidong/sdk/framework/http/HttpManager;->loadingDialog:Lcom/leidong/sdk/framework/view/loading/LoadingDialog;

    .line 63
    iget-object v5, p0, Lcom/leidong/sdk/framework/http/HttpManager;->loadingDialog:Lcom/leidong/sdk/framework/view/loading/LoadingDialog;

    invoke-virtual {v5, v0}, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->setCancelable(Z)V
    ...
    invoke-virtual {v0, v4}, Lcom/leidong/sdk/framework/view/loading/LoadingDialog;->setLoadingMessage(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, v0}, Lcom/leidong/sdk/framework/http/HttpManager;->sendHttpLog(Ljava/lang/String;)V
    ...
    new-instance v5, Lcom/leidong/sdk/framework/http/HttpManager$1;

    invoke-direct {v5, p0, p1, v1, p3}, Lcom/leidong/sdk/framework/http/HttpManager$1;-><init>(Lcom/leidong/sdk/framework/http/HttpManager;Ljava/lang/String;Ljava/lang/String;Lcom/leidong/sdk/framework/http/HttpCallBack;)V

    invoke-virtual {v0, v1, v2, v5}, Lcom/leidong/open/main/OpenHttpUtils;->post(Ljava/lang/String;Ljava/util/Map;Lcom/leidong/open/main/OpenHttpUtils$OpenCallBack;)V
    ...
    new-instance v5, Lcom/leidong/sdk/framework/http/HttpManager$2;

    invoke-direct {v5, p0, p1, v1, p3}, Lcom/leidong/sdk/framework/http/HttpManager$2;-><init>(Lcom/leidong/sdk/framework/http/HttpManager;Ljava/lang/String;Ljava/lang/String;Lcom/leidong/sdk/framework/http/HttpCallBack;)V

    invoke-virtual {v0, v1, v2, v5}, Lcom/leidong/open/main/OpenHttpUtils;->get(Ljava/lang/String;Ljava/util/Map;Lcom/leidong/open/main/OpenHttpUtils$OpenCallBack;)V
