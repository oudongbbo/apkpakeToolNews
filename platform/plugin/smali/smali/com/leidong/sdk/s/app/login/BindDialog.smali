...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v2, p0, Lcom/leidong/sdk/s/app/login/BindDialog;->screenWidth:I

    .line 39
    iget v2, v1, Landroid/util/DisplayMetrics;->heightPixels:I

    iput v2, p0, Lcom/leidong/sdk/s/app/login/BindDialog;->screenHeight:I
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v3, p0, Lcom/leidong/sdk/s/app/login/BindDialog;->mContext:Landroid/content/Context;
    ...
    .line 49
    const-string v0, "leidong_dialog_bind"
    ...
    invoke-virtual {p0, v0}, Lcom/leidong/sdk/s/app/login/BindDialog;->setContentView(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/leidong/sdk/s/app/login/BindDialog;->findViewById(I)Landroid/view/View;

    move-result-object v0

    check-cast v0, Landroid/widget/FrameLayout;

    iput-object v0, p0, Lcom/leidong/sdk/s/app/login/BindDialog;->mContent:Landroid/widget/FrameLayout;
    ...
    iget v4, p0, Lcom/leidong/sdk/s/app/login/BindDialog;->screenWidth:I
    ...
    iget v5, p0, Lcom/leidong/sdk/s/app/login/BindDialog;->screenWidth:I
    ...
    .line 63
    iget-object v1, p0, Lcom/leidong/sdk/s/app/login/BindDialog;->mContent:Landroid/widget/FrameLayout;
    ...
    const-string v2, "leidong_login_bg_dialog"

    const-string v3, "drawable"

    iget-object v4, p0, Lcom/leidong/sdk/s/app/login/BindDialog;->mContext:Landroid/content/Context;
    ...
    .line 67
    iget-object v2, p0, Lcom/leidong/sdk/s/app/login/BindDialog;->mContent:Landroid/widget/FrameLayout;
    ...
    invoke-static {v1, v4}, Lcom/leidong/sdk/framework/utils/ViewUtil;->createRoundConerImage(Landroid/graphics/Bitmap;Ljava/lang/Float;)Landroid/graphics/Bitmap;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 99
    iget-object v0, p0, Lcom/leidong/sdk/s/app/login/BindDialog;->dismissHandler:Landroid/os/Handler;
