...
.method public static exitWebDialog(Landroid/content/Context;Ljava/lang/String;ZZLjava/lang/Object;Lcom/leidong/sdk/framework/interfaces/ResultCallback;)V
    ...
    .param p5, "sdkcallback"    # Lcom/leidong/sdk/framework/interfaces/ResultCallback;
    ...
    invoke-interface {p5, v1}, Lcom/leidong/sdk/framework/interfaces/ResultCallback;->onFail(Ljava/lang/String;)V
    ...
    .line 52
    :cond_1
    new-instance v1, Lcom/leidong/sdk/framework/web/SdkWebDialog;

    invoke-direct {v1, p0}, Lcom/leidong/sdk/framework/web/SdkWebDialog;-><init>(Landroid/content/Context;)V

    .line 53
    .local v1, "webDialog":Lcom/leidong/sdk/framework/web/SdkWebDialog;
    invoke-virtual {v1, p3}, Lcom/leidong/sdk/framework/web/SdkWebDialog;->setTransparent(Z)V

    .line 54
    invoke-virtual {v1, p2}, Lcom/leidong/sdk/framework/web/SdkWebDialog;->setCanBackClose(Z)V

    .line 55
    invoke-virtual {v1, p1}, Lcom/leidong/sdk/framework/web/SdkWebDialog;->setUrl(Ljava/lang/String;)V

    .line 56
    invoke-virtual {v1, p2}, Lcom/leidong/sdk/framework/web/SdkWebDialog;->setCancelable(Z)V

    .line 57
    invoke-virtual {v1, p2}, Lcom/leidong/sdk/framework/web/SdkWebDialog;->setCanceledOnTouchOutside(Z)V

    .line 58
    new-instance v2, Lcom/leidong/sdk/s/core/utils/SdkUtil$1;

    invoke-direct {v2, p5}, Lcom/leidong/sdk/s/core/utils/SdkUtil$1;-><init>(Lcom/leidong/sdk/framework/interfaces/ResultCallback;)V

    invoke-virtual {v1, v2}, Lcom/leidong/sdk/framework/web/SdkWebDialog;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V

    .line 68
    invoke-virtual {v1, p4}, Lcom/leidong/sdk/framework/web/SdkWebDialog;->setJsInterface(Ljava/lang/Object;)V
...
.method public static showSdkWebActivity(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0, v0}, Lcom/leidong/sdk/s/core/utils/SdkUtil;->showWebActivity(Landroid/content/Context;Ljava/lang/String;)V
...
.method public static showWithOtherWebsite(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {p0, v0}, Lcom/leidong/sdk/framework/utils/CommonUtil;->toUri(Landroid/content/Context;Ljava/lang/String;)V
