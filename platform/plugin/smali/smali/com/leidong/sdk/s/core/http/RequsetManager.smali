...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 37
    new-instance v0, Lcom/leidong/sdk/framework/utils/ReqUtil;

    invoke-direct {v0}, Lcom/leidong/sdk/framework/utils/ReqUtil;-><init>()V

    iput-object v0, p0, Lcom/leidong/sdk/s/core/http/RequsetManager;->reqUtil:Lcom/leidong/sdk/framework/utils/ReqUtil;
...
.method private request(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;ZLjava/lang/String;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
    ...
    .param p6, "reqestCallback"    # Lcom/leidong/sdk/framework/http/HttpCallBack;
    ...
    invoke-interface {p6, v0, v1}, Lcom/leidong/sdk/framework/http/HttpCallBack;->onFail(ILjava/lang/String;)V
    ...
    .line 323
    iget-object v1, p0, Lcom/leidong/sdk/s/core/http/RequsetManager;->httpManager:Lcom/leidong/sdk/framework/http/HttpManager;

    sget-boolean v2, Lcom/leidong/sdk/s/core/utils/SLogUtil;->isShowLog:Z
    ...
    invoke-virtual {v1, v0, p6}, Lcom/leidong/sdk/framework/http/HttpManager;->get(Lcom/leidong/sdk/framework/http/HttpBean;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
    ...
    invoke-virtual {v1, v0, p6}, Lcom/leidong/sdk/framework/http/HttpManager;->post(Lcom/leidong/sdk/framework/http/HttpBean;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
...
.method private request2(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;ZLjava/lang/String;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
    ...
    invoke-static {v1, p3}, Lcom/leidong/sdk/framework/utils/ReqUtil;->addCommonParamsWithoutDevice(Landroid/content/Context;Ljava/util/HashMap;)Ljava/util/HashMap;
...
.method private requestFree(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;ZLjava/lang/String;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
    ...
    invoke-static {v1, p3}, Lcom/leidong/sdk/framework/utils/ReqUtil;->addSignParams(Landroid/content/Context;Ljava/util/HashMap;)Ljava/util/HashMap;
...
.method public requestAccessTokenLogin(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/leidong/sdk/framework/http/HttpCallBack;ZLjava/lang/String;)V
    ...
    invoke-static {v1, v2}, Lcom/leidong/sdk/framework/encrypt/CodeManager;->encodeSpecial(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/leidong/sdk/s/core/http/RequsetManager;->request(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;ZLjava/lang/String;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
...
.method public requestBindInfo(Ljava/lang/String;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
    ...
    invoke-direct/range {v1 .. v7}, Lcom/leidong/sdk/s/core/http/RequsetManager;->request2(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;ZLjava/lang/String;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
...
.method public requestGetRegName(Lcom/leidong/sdk/framework/http/HttpCallBack;Z)V
    ...
    iget-object v2, p0, Lcom/leidong/sdk/s/core/http/RequsetManager;->mContext:Landroid/content/Context;

    invoke-static {v2}, Lcom/leidong/sdk/s/core/model/SdkConfigManager;->getGameId(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/leidong/sdk/s/core/model/SdkConfigManager;->getGamePid(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-static {v2}, Lcom/leidong/sdk/framework/utils/CommonUtil;->getMobileDevId(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/leidong/sdk/s/core/http/RequsetManager;->requestFree(Ljava/lang/String;Ljava/lang/String;Ljava/util/HashMap;ZLjava/lang/String;Lcom/leidong/sdk/framework/http/HttpCallBack;)V
...
.method public requestLoginS(Ljava/lang/String;Ljava/lang/String;Lcom/leidong/sdk/framework/http/HttpCallBack;ZLjava/lang/String;)V
    ...
    .line 50
    iget-object v3, p0, Lcom/leidong/sdk/s/core/http/RequsetManager;->mContext:Landroid/content/Context;
    ...
    invoke-static {v3, v4}, Lcom/leidong/sdk/framework/encrypt/CodeManager;->encodeSpecial(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/leidong/sdk/s/core/utils/SLogUtil;->i(Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lcom/leidong/sdk/s/core/utils/SLogUtil;->i(Ljava/lang/String;)V
    ...
    .line 62
    const-string v1, "leidong_tips_waiting"
...
.method public requestPayOrder(Lcom/leidong/sdk/framework/pay/PayInfoBean;Lcom/leidong/sdk/framework/http/HttpCallBack;Z)V
    .locals 8
    .param p1, "info"    # Lcom/leidong/sdk/framework/pay/PayInfoBean;
    .param p2, "reqestCallback"    # Lcom/leidong/sdk/framework/http/HttpCallBack;
    .param p3, "isShow"    # Z
    ...
    invoke-static {v2}, Lcom/leidong/sdk/s/core/model/SdkConfigManager;->getSdkVersion(Landroid/content/Context;)Ljava/lang/String;
...
.method public requestUserAuth(Lcom/leidong/sdk/framework/http/HttpCallBack;)V
    ...
    invoke-static {v2}, Lcom/leidong/sdk/s/core/model/SdkConfigManager;->getUserName(Landroid/content/Context;)Ljava/lang/String;
...
.method public requestUserNoAdultPayMount(Lcom/leidong/sdk/framework/http/HttpCallBack;)V
    ...
    sget-object v3, Lcom/leidong/sdk/s/core/http/RequestUrls;->API_GET_USER_PAYMONEY:Ljava/lang/String;
...
.method public submitSdkAction(Ljava/lang/String;)V
    ...
    invoke-static {v2}, Lcom/leidong/sdk/s/core/model/SdkConfigManager;->getSdkRunID(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v3, Lcom/leidong/sdk/s/core/http/RequestUrls;->API_COLLECT_SDK_RUNNING:Ljava/lang/String;

    const-string v6, "submit"

    new-instance v7, Lcom/leidong/sdk/s/core/http/RequsetManager$1;

    invoke-direct {v7, p0, p1}, Lcom/leidong/sdk/s/core/http/RequsetManager$1;-><init>(Lcom/leidong/sdk/s/core/http/RequsetManager;Ljava/lang/String;)V
