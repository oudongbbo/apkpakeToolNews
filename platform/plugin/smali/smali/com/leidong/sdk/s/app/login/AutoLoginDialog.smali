...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v2, p0, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->screenWidth:I

    .line 54
    iget v2, v1, Landroid/util/DisplayMetrics;->heightPixels:I

    iput v2, p0, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->screenHeight:I
...
.method static synthetic access$000(Lcom/leidong/sdk/s/app/login/AutoLoginDialog;)Landroid/widget/LinearLayout;
    .locals 1
    .param p0, "x0"    # Lcom/leidong/sdk/s/app/login/AutoLoginDialog;
...
.method static synthetic access$100(Lcom/leidong/sdk/s/app/login/AutoLoginDialog;)Landroid/content/Context;
    ...
    .line 22
    iget-object v0, p0, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->mContext:Landroid/content/Context;
...
.method static synthetic access$300(Lcom/leidong/sdk/s/app/login/AutoLoginDialog;)Lcom/leidong/sdk/s/app/login/AutoLoginDialog$AutoLoginListener;
    ...
    .line 22
    iget-object v0, p0, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->autoListener:Lcom/leidong/sdk/s/app/login/AutoLoginDialog$AutoLoginListener;
...
.method static synthetic access$500(Lcom/leidong/sdk/s/app/login/AutoLoginDialog;)I
    ...
    .line 22
    iget v0, p0, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->showTime:I
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v3, p0, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->mContext:Landroid/content/Context;
    ...
    .line 62
    const-string v0, "leidong_login_auto_new"
    ...
    invoke-virtual {p0, v0}, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->setContentView(I)V
    ...
    invoke-virtual {p0, v0}, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->findViewById(I)Landroid/view/View;

    move-result-object v0

    check-cast v0, Landroid/widget/LinearLayout;

    iput-object v0, p0, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->mContent:Landroid/widget/LinearLayout;
    ...
    iget v4, p0, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->screenWidth:I
    ...
    iget v5, p0, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->screenWidth:I
    ...
    .line 70
    iget v1, p0, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->screenWidth:I
    ...
    iput v1, p0, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->widthAnimate:I
    ...
    iput v1, p0, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->heightAnimate:I
    ...
    .line 79
    iget-object v1, p0, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->mContent:Landroid/widget/LinearLayout;

    invoke-virtual {v1, v0}, Landroid/widget/LinearLayout;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    .line 82
    new-instance v1, Lcom/leidong/sdk/s/app/login/AutoLoginDialog$1;

    invoke-direct {v1, p0}, Lcom/leidong/sdk/s/app/login/AutoLoginDialog$1;-><init>(Lcom/leidong/sdk/s/app/login/AutoLoginDialog;)V

    invoke-virtual {p0, v1}, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->setOnShowListener(Landroid/content/DialogInterface$OnShowListener;)V
    ...
    invoke-virtual {p0, v1}, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->findViewById(I)Landroid/view/View;

    move-result-object v1

    check-cast v1, Landroid/widget/TextView;

    iput-object v1, p0, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->login_auto_text:Landroid/widget/TextView;
    ...
    iput-object v1, p0, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->login_auto_switch:Landroid/widget/Button;

    .line 95
    iget-object v1, p0, Lcom/leidong/sdk/s/app/login/AutoLoginDialog;->login_auto_switch:Landroid/widget/Button;

    new-instance v2, Lcom/leidong/sdk/s/app/login/AutoLoginDialog$2;

    invoke-direct {v2, p0}, Lcom/leidong/sdk/s/app/login/AutoLoginDialog$2;-><init>(Lcom/leidong/sdk/s/app/login/AutoLoginDialog;)V
...
.method public setAutoLoginListener(Lcom/leidong/sdk/s/app/login/AutoLoginDialog$AutoLoginListener;)V
    .locals 0
    .param p1, "listener"    # Lcom/leidong/sdk/s/app/login/AutoLoginDialog$AutoLoginListener;
