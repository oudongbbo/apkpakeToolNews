...
.method public constructor <init>(Landroid/content/Context;Lcom/leidong/sdk/s/app/exit/ExitDialog$ExitCallBack;)V
    ...
    .param p2, "callback"    # Lcom/leidong/sdk/s/app/exit/ExitDialog$ExitCallBack;
    ...
    iput v2, p0, Lcom/leidong/sdk/s/app/exit/ExitDialog;->screenWidth:I

    .line 50
    iget v2, v1, Landroid/util/DisplayMetrics;->heightPixels:I

    iput v2, p0, Lcom/leidong/sdk/s/app/exit/ExitDialog;->screenHeight:I
...
.method static synthetic access$000(Lcom/leidong/sdk/s/app/exit/ExitDialog;)Z
    .locals 1
    .param p0, "x0"    # Lcom/leidong/sdk/s/app/exit/ExitDialog;

    .line 26
    iget-boolean v0, p0, Lcom/leidong/sdk/s/app/exit/ExitDialog;->isExitClick:Z
...
.method static synthetic access$100(Lcom/leidong/sdk/s/app/exit/ExitDialog;)Lcom/leidong/sdk/s/app/exit/ExitDialog$ExitCallBack;
    ...
    .line 26
    iget-object v0, p0, Lcom/leidong/sdk/s/app/exit/ExitDialog;->mCallback:Lcom/leidong/sdk/s/app/exit/ExitDialog$ExitCallBack;
...
.method static synthetic access$200(Lcom/leidong/sdk/s/app/exit/ExitDialog;)Landroid/widget/RelativeLayout;
    ...
    .line 26
    iget-object v0, p0, Lcom/leidong/sdk/s/app/exit/ExitDialog;->exitdialog_ad_view:Landroid/widget/RelativeLayout;
...
.method private initViews()V
    ...
    iget v5, p0, Lcom/leidong/sdk/s/app/exit/ExitDialog;->screenWidth:I
    ...
    iget-object v3, p0, Lcom/leidong/sdk/s/app/exit/ExitDialog;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {p0, v1}, Lcom/leidong/sdk/s/app/exit/ExitDialog;->findViewById(I)Landroid/view/View;

    move-result-object v1

    check-cast v1, Landroid/widget/ImageView;

    iput-object v1, p0, Lcom/leidong/sdk/s/app/exit/ExitDialog;->exitdialog_starlogo:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, Lcom/leidong/sdk/s/app/exit/ExitDialog;->exitdialog_bg:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, Lcom/leidong/sdk/s/app/exit/ExitDialog;->exitdialog_bbsbtn:Landroid/widget/ImageButton;
    ...
    iput-object v1, p0, Lcom/leidong/sdk/s/app/exit/ExitDialog;->exitdialog_giftbtn:Landroid/widget/ImageButton;
    ...
    iput-object v1, p0, Lcom/leidong/sdk/s/app/exit/ExitDialog;->exitdialog_exitbtn:Landroid/widget/Button;
    ...
    iput-object v1, p0, Lcom/leidong/sdk/s/app/exit/ExitDialog;->exitdialog_ad_view:Landroid/widget/RelativeLayout;
    ...
    sget-object v2, Lcom/leidong/sdk/s/core/http/RequestUrls;->URL_EXIT_IMAGE:Ljava/lang/String;

    new-instance v3, Lcom/leidong/sdk/s/app/exit/ExitDialog$2;

    invoke-direct {v3, p0}, Lcom/leidong/sdk/s/app/exit/ExitDialog$2;-><init>(Lcom/leidong/sdk/s/app/exit/ExitDialog;)V

    invoke-virtual {v1, v2, v3}, Lcom/leidong/sdk/framework/utils/ImageUtil;->loadBitmap(Ljava/lang/String;Lcom/leidong/sdk/framework/utils/ImageUtil$ImageCallback;)V

    .line 123
    :goto_1
    iget-object v1, p0, Lcom/leidong/sdk/s/app/exit/ExitDialog;->exitdialog_bg:Landroid/widget/ImageView;

    new-instance v2, Lcom/leidong/sdk/s/app/exit/ExitDialog$ExitDialogBitmapListener;

    invoke-direct {v2, p0}, Lcom/leidong/sdk/s/app/exit/ExitDialog$ExitDialogBitmapListener;-><init>(Lcom/leidong/sdk/s/app/exit/ExitDialog;)V

    invoke-virtual {v1, v2}, Landroid/widget/ImageView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 125
    iget-object v1, p0, Lcom/leidong/sdk/s/app/exit/ExitDialog;->exitdialog_bbsbtn:Landroid/widget/ImageButton;

    new-instance v2, Lcom/leidong/sdk/s/app/exit/ExitDialog$ExitDialogBBSListener;

    invoke-direct {v2, p0}, Lcom/leidong/sdk/s/app/exit/ExitDialog$ExitDialogBBSListener;-><init>(Lcom/leidong/sdk/s/app/exit/ExitDialog;)V

    invoke-virtual {v1, v2}, Landroid/widget/ImageButton;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 127
    iget-object v1, p0, Lcom/leidong/sdk/s/app/exit/ExitDialog;->exitdialog_giftbtn:Landroid/widget/ImageButton;

    new-instance v2, Lcom/leidong/sdk/s/app/exit/ExitDialog$ExitDialogGiftListener;

    invoke-direct {v2, p0}, Lcom/leidong/sdk/s/app/exit/ExitDialog$ExitDialogGiftListener;-><init>(Lcom/leidong/sdk/s/app/exit/ExitDialog;)V

    invoke-virtual {v1, v2}, Landroid/widget/ImageButton;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 129
    iget-object v1, p0, Lcom/leidong/sdk/s/app/exit/ExitDialog;->exitdialog_exitbtn:Landroid/widget/Button;

    new-instance v2, Lcom/leidong/sdk/s/app/exit/ExitDialog$ExitDialogExitListener;

    invoke-direct {v2, p0}, Lcom/leidong/sdk/s/app/exit/ExitDialog$ExitDialogExitListener;-><init>(Lcom/leidong/sdk/s/app/exit/ExitDialog;)V
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    .line 57
    const-string v0, "leidong_dialog_exitgame"
    ...
    invoke-virtual {p0, v0}, Lcom/leidong/sdk/s/app/exit/ExitDialog;->setContentView(I)V

    .line 59
    invoke-direct {p0}, Lcom/leidong/sdk/s/app/exit/ExitDialog;->initViews()V

    .line 61
    new-instance v0, Lcom/leidong/sdk/s/app/exit/ExitDialog$1;

    invoke-direct {v0, p0}, Lcom/leidong/sdk/s/app/exit/ExitDialog$1;-><init>(Lcom/leidong/sdk/s/app/exit/ExitDialog;)V

    invoke-virtual {p0, v0}, Lcom/leidong/sdk/s/app/exit/ExitDialog;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V
