...
public class BuildApkByMid {
	...
	public static void buildSingleMdidApk(ApkParser apkCfg, String mdid) {
		...
		String mdidPath = mdidParentPath+File.separator+"leidongGame.ini";
		...
		sendLog("解压缩:" + "assets" + File.separator + "leidongGame.ini");

		if (RarUtil.unRar(apkCfg.apkPath, "assets" + File.separator + "leidongGame.ini", mdidParentPath)) {
			String gidPath = mdidParentPath + File.separator + "leidongGame.ini";
			...
			try {
				...
				sendLog("删除apk中的leidongGame.ini ");
				String deletePath = "  " + "assets" + File.separator + "leidongGame.ini ";
				RarUtil.deleteFile(apkPath, deletePath);

				sendLog("新增apk中的leidongGame.ini ");
