...
public class Common {
    ...
    public static final String Default_SDKTAG = "leidong";
    ...
    public static String getSplahPathByTemp(ApkParser apkCfg) {
        return Common.getApkTempPath(apkCfg) + File.separator + "assets" + File.separator + "leidong_splash" + File.separator;
    }
