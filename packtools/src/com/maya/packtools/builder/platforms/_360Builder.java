...
public class _360Builder extends BaseBuilder {
    ...
    protected String handleApplication(String manifest) {
        return replaceApplication("com.feimiao.sdk.m.platform.QiHooApplication", manifest);
    }
    ...
    protected void handleSdkPlugins(String sdkplugin, Properties prop) {
        ...
        Pattern p = Pattern.compile("android:name=\"QHOPENSDK_APPID\" android:value=\"(.*?)\"");
        ...
        p = Pattern.compile("android:name=\"QHOPENSDK_APPKEY\" android:value=\"(.*?)\"");
        ...
        p = Pattern.compile("android:name=\"QHOPENSDK_PRIVATEKEY\" android:value=\"(.*?)\"");
        m = p.matcher(_360Content);
        m.find();
